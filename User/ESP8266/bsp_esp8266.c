...
bool ESP8266_BuildAP ( char * pSSID, char * pPassWord, ENUM_AP_PsdMode_TypeDef enunPsdMode )
{
	...
	sprintf ( cCmd, "AT+CWSAP_CUR=\"%s\",\"%s\",1,%d", pSSID, pPassWord, enunPsdMode );
...
char * ESP8266_ReceiveString ( FunctionalState enumEnUnvarnishTx )
{
	...
	while ( ! strEsp8266_Fram_Record .InfBit .FramFinishFlag );//等待一帧数据传输完成
	strEsp8266_Fram_Record .Data_RX_BUF [ strEsp8266_Fram_Record .InfBit .FramLength ] = '\0';//为数据帧添加结束符
